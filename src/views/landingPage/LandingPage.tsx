    ...
    <div  className="text-gray-900 box-content w-full text-center flex justify-center">
      ...
      <div className="hero-content">
        <div className="text-center flex flex-col justify-center">
          <h1 className="mb-5 text-center text-5xl font-bold lg:text-9xl font-normal"> Github Data Fetcher!</h1>
          <div >
          ...
          <Link to='repository'>
            <Button handleClick={()=>{}} className="bg-transparent text-yellow-400 border-yellow-400 border-2 text-5xl  mt-9">Get Started</Button>
          </Link>
        </div>
      </div>
    </div>
